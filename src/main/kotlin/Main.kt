...
fun main(args: Array<String>) {
    val test = measureTimeMillis {
        ...
        list.add(mutableListOf(20, 4, 82, 47, 65))
        list.add(mutableListOf(19, 1, 23, 75, 3, 34))
        list.add(mutableListOf(88, 2, 77, 73, 7, 63, 67))
        list.add(mutableListOf(99, 65, 4, 28, 6, 16, 70, 92))
        list.add(mutableListOf(11, 41, 26, 56, 83, 40, 80, 70, 33))
        list.add(mutableListOf(41, 48, 72, 33, 47, 32, 37, 16, 94, 29))
        list.add(mutableListOf(53, 71, 44, 65, 25, 43, 91, 52, 97, 51, 14))
        list.add(mutableListOf(70, 11, 33, 28, 77, 73, 17, 78, 39, 68, 17, 57))
        list.add(mutableListOf(91, 71, 52, 38, 17, 14, 91, 43, 58, 50, 27, 29, 48))
        list.add(mutableListOf(63, 66, 4, 68, 89, 53, 67, 30, 73, 16, 69, 87, 40, 31))
        list.add(mutableListOf(4, 62, 98, 27, 23, 9, 70, 98, 73, 93, 38, 53, 60, 4, 23))
        var tempList: MutableList<Int> = list[14]

        for (row in 13 downTo 0) {
            tempList = mutableListOf<Int>().apply {
                list[row].forEachIndexed { index, it ->
                    this.add(maxOf(it + tempList[index], it + tempList[index + 1]))
                }
            }
        }
        println("The maximum total is: ${tempList[0]}")
    }
...
//                    if (index == 0)
//                        this.add(it + list[row][index])
//                    else if (index < (size - 2))
//                        this.add(maxOf(it + list[row][index], it + list[row][index - 1]))
//                    else if (index == size - 1)
//                        this.add(it + list[row][index - 1])
//                }
